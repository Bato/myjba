...
Spring web app tutorial 41: JQuery Validation Plugin Remote
      http://www.javavids.com/video/spring-web-app-tutorial-41-jquery-validation-plugin-remote.html
###############################################################################
How to use custom validation where business rules are defined on the server 
with JQuery Validation Plugin. 
Also how to customize messages used in JQuery Validation Plugin.

Integrate jQuery Validator
...
Test:		
	http://localhost:8080/register/available.html?username=admin
		false
	Keyboard Shortcuts: Open Developer Tools : Ctrl+Shift+I	, F12
...
feeds.feedburner.com/javavids?format=xml
http://feeds.feedburner.com/javavids?format=xml
	
###############################################################################
Spring web app tutorial 45: Save items
                            http://www.javavids.com/video/spring-web-app-tutorial-45-save-items.html
###############################################################################
...
Spring web app tutorial 46: CLOB
                                  http://www.javavids.com/video/spring-web-app-tutorial-46-clob.html
###############################################################################
